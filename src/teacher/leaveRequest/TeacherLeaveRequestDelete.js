...
import { deleteLeaveRequestAction } from "./TeacherLeaveRequestActions";

const TeacherLeaveRequestDelete = ({
  leaveRequestDelete,
  setOpenDeletePopup,
}) => {
  const dispatch = useDispatch();
  const handleDelete = () => {
    dispatch(deleteLeaveRequestAction(leaveRequestDelete));
  };
...
export default TeacherLeaveRequestDelete;
